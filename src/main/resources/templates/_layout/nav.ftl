            ...
            <ul class="nav navbar-nav navbar-right" style="padding-right: 15px;">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li>
                            <a href="/profile/modifyPassword">
                                <span class="glyphicon glyphicon-check" aria-hidden="true"></span> 修改密码
                            </a>
                        </li>
                        <li role="separator" class="divider"></li>
                        <li>
                            <a href="/passport/loginout">
                                <span class="glyphicon glyphicon-log-out" aria-hidden="true"></span> 注销登录
                            </a>
                        </li>
                    </ul>
                </li>
